...
mean_by_total_day = mean(total_by_day, na.rm = TRUE) %>%
mean_by_total_day
mean_step_by_day = mean(step_by_day) %>%
mean_step_by_day 

#Comparing the median of total_by_day and step_by_day

median_by_total_day = mean(total_by_day, na.rm = TRUE) %>%
median_by_total_day
median_step_by_day = mean(step_by_day) %>%
median_step_by_day 
